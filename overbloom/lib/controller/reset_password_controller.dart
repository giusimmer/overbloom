...
class ResetPasswordController {
  ...
  Future<void> resetPassword({
    ...
    try {
      ...
      updateMessage("E-mail de recuperação enviado! Verifique sua caixa de entrada.");
  ...
  // /// Método para verificar se o e-mail está cadastrado no Firebase
  ...
  Future<bool> _checkIfEmailExists(String email) async {
    try {
      var querySnapshot = await FirebaseFirestore.instance
          .collection('users') // Certifique-se de que está na coleção certa
          .where('email', isEqualTo: email)
          .limit(1) // Para otimizar a busca
          .get();

      return querySnapshot.docs.isNotEmpty;
    } catch (e) {
      print("Erro ao verificar e-mail: $e");
      return false; // Em caso de erro, trate como se o e-mail não existisse
    }
  }
